/**
 * Site Detection and Control Module
 * Handles different presentation platforms with specific controls
 */
...
class SiteDetector {
  ...
  detectCurrentSite() {
    ...
    if (
      hostname.includes("powerpoint.office.com") ||
  ...
  getSiteControls() {
    ...
    return controls[this.currentSite] || controls.google_slides; // Default fallback
  }
  ...
  simulateKeyboardEvent(key, type = "keydown") {
  ...
  isInPresentationMode() {
    ...
    switch (this.currentSite) {
      ...
      case "prezi":
        return (
          url.includes("/present/") ||
          document.querySelector(".prezi-presentation")
        );
      default:
        return false;
    }
